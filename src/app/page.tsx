export default function Dashboard() {
  const metrics = [
    { label: "GMV", value: "$225000" },
    { label: "ARR", value: "$180000" },
  ...
  return (
    <div className="space-y-8">
      <div className="bg-black text-white px-6 py-4 rounded-2xl shadow-md flex justify-between">
        <h1 className="font-semibold">Cashup Card — TRL-5.5 Live Demo</h1>
        <p className="text-sm text-gray-300">Pay 80 → Get 100 · 25% uplift · 8% fee</p>
      </div>
      ...
      <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white px-6 py-4 rounded-2xl shadow-md">
        ...
        <p className="text-sm text-gray-300">Dataset 83,333 pop · cap 3% → ≈2,500 cards · 25% uplift</p>
      </div>

      <h3 className="text-lg font-semibold text-gray-900">Key Metrics</h3>
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
        {metrics.map((m) => (
          <div key={m.label} className="rounded-xl bg-white border border-gray-300 p-5 text-center shadow">
      ...
      <h3 className="text-lg font-semibold text-gray-900">Active Drop Cells (GTA)</h3>
      ...
      <h3 className="text-lg font-semibold text-gray-900">Agentic AI — Live Log</h3>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {agents.map((a) => (
          <div key={a.name} className="rounded-xl bg-white border border-gray-300 p-5 shadow text-gray-900">
